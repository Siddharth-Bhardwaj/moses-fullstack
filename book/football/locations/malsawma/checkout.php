<?php
	...
	$host = "https://1380b437f111.ngrok.io";
	$notifyUrl = $host. "/moses/book/football/locations/malsawma/notify.php";
	$returnUrl = $host. "/moses/book/football/locations/malsawma/return.php";
